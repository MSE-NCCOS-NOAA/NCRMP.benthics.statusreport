## Function to calculate colony density for combined SCREAM and DRM data
## from 1999 to 2013
...
# outputs created in this file used in this package--------------
# density_site
...
# NCRMP_calculate_Z_scores_density
